...
# データをロード --- (※1)
def main():
    X_train, X_test, y_train, y_test = np.load("/content/shinemuscat_color4_makedata3.npy",allow_pickle=True)
...
def model_train(X, y):
    ...
    hdf5_file = "/content/shinemuscat-color4-model_30_300_yellow-b_green-1-2_grenn-3-4b.hdf5"
